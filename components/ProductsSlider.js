    ...
    return(
        <div>
            ...
            <div id='slider' className='w-full h-full overflow-x-scroll scroll whitespace-nowrap scroll-smooth scrollbar-hide pb-5'>
                {
                    ShoeData.products.map((data) => {
                        return(
                            <div key={data.key} className="glassmorph inline-block p-2 cursor-pointer w-64 lg:w-96">
                                <img src={data.image} className="w-15 lg:w-32 mx-auto h-32"/>
