...
export default function Footer(){
    return(
        <div className="text-gray-300 mx-auto bg-black py-10 text-sm font-light font-Koho">
            ...
            <div className="w-11/12 lg:w-10/12 flex flex-wrap justify-around mx-auto">
                ...
                <p className="font-Koho text-2xl font-bold">Socials</p>
                    <ul>
                        <li className="hover:text-gray-100 cursor-pointer flex"><SiFacebook/> <span className="px-5">Facebook</span></li>
                        <li className="hover:text-gray-100 cursor-pointer flex"><SiTwitter /><span className="px-5">Twitter</span></li>
                        <li className="hover:text-gray-100 cursor-pointer flex"><SiInstagram /><span className="px-5">Instagram</span></li>
                    </ul>
                </div>
            </div>
        </div>
